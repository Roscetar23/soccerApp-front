        ...
        <div className="w-full bg-slate-800/50 backdrop-blur-sm border border-emerald-500/20 rounded-2xl p-8 flex flex-col gap-4 shadow-2xl">
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-white hover:bg-gray-100 text-slate-900 font-semibold transition-colors duration-200 shadow-md"
            >
              {/* Google icon */}
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-slate-700 hover:bg-slate-600 text-white font-semibold transition-colors duration-200 border border-slate-600 shadow-md"
            >
              {/* GitHub icon */}
