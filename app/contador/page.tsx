...
export default async function ContadorPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-background px-4 py-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-foreground mb-8 text-center">
          Próximos <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon to-cyan-500">Partidos</span>
        </h1>
